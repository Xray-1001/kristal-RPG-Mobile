...
// Koordinat dasar mengikuti tata letak gambar lobby (700x467)
const LOBBY_BUILDINGS = [
  {name:"Balai Guild",           x:340, y:95,  r:44, action:"guild"},
  {name:"Toko Senjata & Armor",  x:182, y:108, r:44, action:"shop"},
  {name:"Merchant Ramuan",       x:483, y:108, r:44, action:"merchant"},
  {name:"Gerbang Dungeon",       x:611, y:126, r:46, action:"dungeon_select"},
  {name:"Penginapan",            x:98,  y:222, r:42, action:"inn"},
  {name:"Bank",                  x:451, y:230, r:40, action:"bank"},
  {name:"Tukang Besi",           x:568, y:230, r:40, action:"blacksmith"},
  {name:"Papan Misi",            x:219, y:362, r:38, action:"questboard"},
  {name:"Pasar",                 x:465, y:362, r:40, action:"market"},
];
let keysHeld = {};
...
function renderOverworld(){
  ...
  function loop(){
    ...
    player.pos.x = Math.max(20, Math.min(680, player.pos.x));
    player.pos.y = Math.max(20, Math.min(447, player.pos.y));
